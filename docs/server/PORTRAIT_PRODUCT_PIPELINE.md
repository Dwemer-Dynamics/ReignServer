...
Native build is interpreted by subject sex. For women it controls natural tone, firmness and athletic definition without adding masculine bodybuilder mass or bulk; for men it controls muscle mass. The five female build descriptions therefore range from minimal tone through highly toned and athletic, while the existing male muscle-mass descriptions remain unchanged. Native weight remains an independent body-fat/fullness axis for both.
