    ...
    internal static partial class Program
    {
        private static List<Dictionary<string, object>> RunGovernmentSystemSelfTests()
        {
            ...
            bool ordinaryPromptOverrideRoutesTestActions =
                ShouldRouteGuardedPromptOverrideActions(true, false, false);
            bool certificationIsolationRoutesNaturalDialogue =
                !ShouldRouteGuardedPromptOverrideActions(true, true, false);
            bool actionCooperationRoutesNaturalDialogue =
                !ShouldRouteGuardedPromptOverrideActions(true, false, true);
            bool ordinaryDialogueRoutesNaturalDialogue =
                !ShouldRouteGuardedPromptOverrideActions(false, false, false);
            add("government.certification_memory_isolation_action_routing",
                ...
                && actionCooperationRoutesNaturalDialogue
