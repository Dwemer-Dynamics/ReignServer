...
```sh
dotnet /path/to/validated/ReignServer.dll --generate-profile-library \
  ...
  --output /path/to/ReignServer/profiles/profile_catalog.json

dotnet /path/to/validated/ReignServer.dll --validate-profile-library
```
