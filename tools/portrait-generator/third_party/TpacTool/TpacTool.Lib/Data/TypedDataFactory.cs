...
namespace TpacTool.Lib
{
	public static class TypedDataFactory
	{
		...
		static TypedDataFactory()
		{
			...
			// Bannerlord's current packages use this segment type for the resident
			// (low-mip) texture payload. Its binary layout is TexturePixelData.
			RegisterType(Guid.Parse("54d56503-9944-4140-ad17-55bbd9ce9e39"), typeof(TexturePixelData));
